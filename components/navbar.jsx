...
const Navbar = () => {
  ...
  if (mblMenu) {
    ...
    return (
      <div>
        <header className="js-page-header page-header--transparent fixed top-0 z-20 w-full bg-white backdrop-blur transition-colors js-page-header--is-sticky">
          <div className="flex items-center bg-white px-6 py-6 xl:px-24 ">
            {/* <!-- Logo --> */}
            ...
            <Link href="/">
              <a className="shrink-0">
                ...
                <img
                  src="/images/logo_white.png"
                  className="max-h-16 h-auto lg:ml-24"
                  alt="Ayris.Dev | NFT Marketplace"
                />
              </a>
            </Link>
