...
const CollectionDropdown = ({ collectionList }) => {
    ...
    <>
      ...
      <div
        ...
        <span className="flex items-center">
          <img
            src={activeItem ? activeItem : "/images/chains/ETH.png"}
            alt="eth"
            className="mr-2 h-5 w-5 rounded-full"
          />
          {activeCollection ? activeCollection : "Artlux Collection"}
        </span>
            ...
            <li key={collectionList.id}>
              <button
                ...
                onClick={() => {
                  ...
                  setActiveCollection(collectionList.title);
                }}>
