  ...
  return (
    <>
      ...
      <header className="js-page-header bg-[#FEFEFE] fixed top-0 z-20 w-full backdrop-blur transition-colors">
        <div className="flex items-center px-6 pt-4 pb-6  xl:px-24 ml-[90px]  ">
          ...
          <form
            action="search"
            className="relative ml-12 mr-8 hidden basis-3/12 lg:block xl:ml-[24%] shadow-sm  shadow-white-500">
            <input
              type="search"
