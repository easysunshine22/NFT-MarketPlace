...
const Header = ({ categoryList }) => {
  ...
  return (
    <>
      ...
      <header className="js-page-header bg-[#FEFEFE] fixed top-0 z-20 w-full backdrop-blur transition-colors">
        <div className="flex items-center px-6 pt-4 pb-6  xl:px-24 lg:ml-[90px]  ">
          ...
          <div className="js-mobile-menu dark:bg-jacarta-800 invisible fixed inset-0 z-10 xl:ml-48 items-center bg-white opacity-0 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent">
          ...
          <form
            action="search"
            className="relative ml-12 mr-24 hidden basis-3/12 lg:block xl:ml-[24%] shadow-sm  shadow-white-500">
            <input
              type="search"
              className="text-jacarta-700 placeholder-jacarta-500  focus:ring-accent border-jacarta-200/20 w-full rounded-lg border py-[0.6875rem] px-4 pl-4 dark:border-transparent dark:bg-white/[.15] dark:text-white dark:placeholder-white"
              placeholder="Search"
            />
            <span className="absolute right-0 top-0 flex h-full w-12 items-center justify-center rounded-2xl">
              <svg
                ...
                width={24}
                height={24}
                className="fill-green h-4 w-4 dark:fill-white">
                <path fill="none" d="M0 0h24v24H0z" />
          ...
          <div className="ml-8 hidden items-center lg:flex xl:ml-12">
            ...
            <div className="js-nav-dropdown group-dropdown relative">
              <button className="dropdown-toggle border-jacarta-100 hover:bg-orange focus:bg-accent group dark:hover:bg-accent ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width={24}
            ...
            <div className="js-nav-dropdown group-dropdown relative">
              ...
              <div className="dropdown-menu dark:bg-jacarta-800 group-dropdown-hover:opacity-100 group-dropdown-hover:visible !-right-4 !top-[85%] !left-auto z-10 min-w-[14rem] whitespace-nowrap rounded-xl bg-white transition-all will-change-transform before:absolute before:-top-3 before:h-3 before:w-full lg:absolute lg:grid lg:!translate-y-4 lg:py-4 lg:px-2 lg:shadow-2xl hidden lg:invisible lg:opacity-0">
                <div className="border-jacarta-100"></div>
              </div>
            </div>
          </div>
      ...
      <div
        ...
        <form action="search" className="relative mt-32 mb-8 w-full lg:hidden">
          <input
            type="search"
        ...
        <nav className="navbar w-full">
          <ul className="flex flex-col lg:flex-row">
              ...
              <Link href="/drops">
                <a>
                  <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                    <span
                      className={
                        isChildrenPageActive("/drops", route.asPath)
                          ? "text-accent dark:text-accent"
                          : ""
                      }>
                      Drops
            ...
            <li className="js-nav-dropdown group relative">
              <button
                onClick={() => mobileCollapse(stats.id)}
                className="dropdown-toggle text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 w-full">
                <span
                  className={
                    isParentPageActive(stats.pages, route.asPath)
              ...
              <ul
                className={`dropdown-menu left-0 top-[85%] z-10 grid-flow-row grid-cols-[repeat(2,_1fr)] gap-x-4 whitespace-nowrap rounded-xl bg-white transition-all will-change-transform group-hover:visible group-hover:opacity-100 dark:bg-jacarta-800 lg:invisible lg:absolute lg:!grid lg:translate-y-4 lg:py-8 lg:px-2 lg:opacity-0 lg:shadow-2xl lg:group-hover:translate-y-2 relative ${
                  isCollapse === stats.id ? "block" : "hidden"
                }`}>
                {stats?.pages?.map((page) => (
                  <li key={page.id} onClick={() => setToggle(false)}>
                    <Link href={page.path}>
