...
const Tarms = () => {
  return (
    <div>
      <Meta title="Tarms || Artlux  NFT Marketplace " />
        ...
        <section className="dark:bg-jacarta-800 relative py-16 md:py-24">
          ...
          <div className="container">
            ...
            <div className="article-content mx-auto max-w-[48.125rem]">
              ...
              <p>
                Ayris.Dev is not a wallet provider, exchange, broker, financial
                institution, or creditor. Ayris.Dev provides a peer-to-peer web3
              ...
              <p>
                ...
                Ayris.Dev relating to your access to and use of the Service.
                ...
                consent of Ayris.Dev, and Ayris.Dev’s failure to assert any
              ...
              <p>
                ...
                compliance with applicable local laws. You and Ayris.Dev agree
