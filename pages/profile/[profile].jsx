...
const Edit_user = () => {
  ...
  const updateProfile = async (sanityClient = client) => {
    const userDoc = {
      _type: "users",
      _id: address,
    };
  ...
  const updateBannerImage = async (sanityClient = client) => {
    await client.assets
      .upload("image", coverePhoto, {
        filename: coverePhoto,
      })
      .then((imageAsset) => {
  ...
  const updateProfileImage = async (sanityClient = client) => {
    await client.assets
      .upload("image", profilePhoto, {
      ...
      <div className="pt-[5.5rem] lg:pt-24">
        ...
        <section className="dark:bg-jacarta-800 relative py-16">
          ...
          <div className="container">
            <div className="mx-auto max-w-[60rem] md:flex">
              {/* <!-- Form --> */}
              <div className="mb-12 md:w-1/2 md:pr-8">
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    placeholder={collection.userName}
                    required
                  />
                </div>
                {/* <!-- Bio --> */}
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 w-full rounded-lg py-3 hover:ring-2 dark:text-white px-3"
                    required
                    placeholder={collection.bio}></textarea>
                </div>
                {/* <!-- Email Address --> */}
                <div className="mb-6">
                  <label className="font-display text-jacarta-700 mb-1 block text-sm dark:text-white">
                  ...
                  <input
                    ...
                    id="profile-email"
                    className="dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 w-full rounded-lg py-3 hover:ring-2 dark:text-white px-3"
                    placeholder={collection.emailAddress}
                    required
                  />
                </div>
                {/* <!-- Links --> */}
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder={collection.twitterHandle}
                    />
                  </div>
                  {/* <!-- Instagram --> */}
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder={collection.igHandle}
                    />
                  </div>
                  {/* <!-- WebSite --> */}
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder={collection.webHandle}
                    />
                  </div>
                </div>
                {/* <!-- Wallet Address --> */}
